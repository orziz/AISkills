...
8. 若正文中引用了 `skills/<skill-name>/SKILL.md`、`skills/<skill-name>/references/`、`skills/<skill-name>/assets/`、`skills/<skill-name>/scripts/`，或 `references/`、`assets/`、`scripts/` 下的相对路径，生成手动安装文件时都要改写成目标目录内真实可用的入口与资源路径。
