...
scenario: 模糊需求、方案评审、复杂任务推进、问题诊断与持续收口
---
...
若需要默认文件结构、状态流转、续跑优先级或模板骨架，可按需阅读 `references/workflow-kit.md`。
...
- 若项目缺少现成骨架，可直接使用 `assets/main-template.md` 与 `assets/execution-template.md`
