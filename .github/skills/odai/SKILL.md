...
1. 当前仓库的唯一标准源入口是 `SKILL.md`。
2. 内部模块正文放在 `references/modules/`。
3. 模块级 support files 放在 `references/<module-name>/`、`assets/<module-name>/`、`scripts/<module-name>/`。
