...
9. 若规格已经稳定，但用户可见行为、状态体验、页面流程或验收口径仍然说不清，要明确切到内部 `design-spec` 模块做 BDD 层收口。
10. 命中附件、低信息输入、步进式提问或候选方案扩展时，读 `references/feature-plan/planning-playbook.md`；命中 bug、输出策略或交付边界时，读 `references/feature-plan/delivery-playbook.md`。
