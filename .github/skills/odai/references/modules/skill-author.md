...
此模块司标准源。务在将既定能力纳入 odai，不别起第二外部 skill。所落者，当为标准模块源 `references/modules/<module-name>.md` 与必要 support files。
...
1. canonical 路径默认 `references/modules/<module-name>.md`；第一版即落真实源，不止聊天草稿。
